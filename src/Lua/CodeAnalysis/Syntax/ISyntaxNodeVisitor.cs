...
public interface ISyntaxNodeVisitor<TContext, TResult>
{
    ...
    TResult VisitFunctionDeclarationExpressionNode(
        FunctionDeclarationExpressionNode node,
        TContext context
    );
    TResult VisitFunctionDeclarationStatementNode(
        FunctionDeclarationStatementNode node,
        TContext context
    );
    TResult VisitLocalFunctionDeclarationStatementNode(
    ...
    TResult VisitTableConstructorExpressionNode(
        TableConstructorExpressionNode node,
        TContext context
    );
    TResult VisitTableMethodDeclarationStatementNode(
        TableMethodDeclarationStatementNode node,
        TContext context
    );
    TResult VisitTableIndexerAccessExpressionNode(
        TableIndexerAccessExpressionNode node,
        TContext context
    );
    TResult VisitTableMemberAccessExpressionNode(
        TableMemberAccessExpressionNode node,
        TContext context
    );
    TResult VisitCallTableMethodExpressionNode(
    ...
    TResult VisitVariableArgumentsExpressionNode(
